...
class ResConfigSettings(models.TransientModel):
    ...
    sr_managers_only_cancel = fields.Boolean(
        string="Only Inventory Managers can cancel others' operations",
        help="Users can still cancel operations they created themselves. Managers and Admins can cancel any in-progress operation.",
