...
class StockPicking(models.Model):
    ...
    # (Cancel-others'-operations restriction removed - unreliable in testing, held back for a future release)
    ...
    def button_validate(self):
        ...
        # (Block zero-quantity validation removed - unreliable in testing, held back for a future release)
